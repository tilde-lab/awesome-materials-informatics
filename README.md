...
- [CDVAE](https://github.com/txie-93/cdvae) **Python** Crystal Diffusion Variational AutoEncoder (CDVAE) generates novel, stable materials by learning from a dataset containing existing material structures or generates high-performing materials by optimizing a specific property in the latent space (i.e. inverse design) [![Github Stars](https://img.shields.io/github/stars/txie-93/cdvae?style=social)](https://github.com/txie-93/cdvae)
