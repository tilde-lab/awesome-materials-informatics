...
- [mat_discover](https://sparks-baird.github.io/mat_discover/) - A materials discovery algorithm geared towards exploring high performance candidates in new chemical spaces using composition-only (**Python**). ![GitHub Repo stars](https://img.shields.io/github/stars/sparks-baird/mat_discover?style=social)
...
- [rmsd](https://github.com/charnley/rmsd) - Calculate Root-mean-square deviation (RMSD) of two molecules, using rotation, in xyz or pdb format (**Python**). [![Github Stars](https://img.shields.io/github/stars/charnley/rmsd?style=social)](https://github.com/charnley/rmsd)
