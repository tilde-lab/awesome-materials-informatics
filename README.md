...
- [mat_discover](https://sparks-baird.github.io/mat_discover/) - A discovery algorithm for high-performance candidates in chemical spaces, composition-only (**Python**). ![GitHub Repo stars](https://img.shields.io/github/stars/sparks-baird/mat_discover?style=social)
